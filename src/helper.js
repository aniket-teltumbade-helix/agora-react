...
const Authorization = `Basic ${Buffer.from(`e58fdcdefc1c4ee7a58fa8fcd316f02f:3c8dd107334349ce877417c488b191ce`).toString("base64")}`;
...
exports.recordStart = async (RecordingUID, resourceId) => {
    var data = {
        ...
        "uid": `${RecordingUID}`,
        "clientRequest": {
            "token": '006b99b87affd9948e19aa9e4a01e86ac66IAAXGbq8iqKa4hsoHW7gDPo6pVhzYWxagExxKHSOKhilmYaHNMoAAAAAEADsTG0XMtGYYQEAAQAx0Zhh',
            "recordingConfig": {
                "maxIdleTime": 120,
                "streamTypes": 3,
                "channelType": 0,
